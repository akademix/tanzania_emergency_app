...
export const snakeBiteGuide: GuideData = {
  ...
  audioEnPath: "/audio/snake/snake_bite_title_english.wav",
  audioSwPath: "/audio/snake/snake_bite_title_swahili.wav",
  descriptionAudioEnPath: "/audio/snake/snake_bite_description_english.wav",
  descriptionAudioSwPath: "/audio/snake/snake_bite_description_swahili.wav",
  steps: [
    {
      instruction: { 
      ...
      audioEnPath: "/audio/snake/snake_bite_step1_english.wav",
      audioSwPath: "/audio/snake/snake_bite_step1_swahili.wav"
    },
    {
      instruction: { 
      ...
      audioEnPath: "/audio/snake/snake_bite_step2_english.wav",
      audioSwPath: "/audio/snake/snake_bite_step2_swahili.wav"
    },
    {
      instruction: { 
      ...
      audioEnPath: "/audio/snake/snake_bite_step3_english.wav",
      audioSwPath: "/audio/snake/snake_bite_step3_swahili.wav"
    },
    {
      instruction: { 
      ...
      audioEnPath: "/audio/snake/snake_bite_step4_english.wav",
      audioSwPath: "/audio/snake/snake_bite_step4_swahili.wav"
    }
  ],
  dangerWarnings: [
    { 
      ...
      audioEnPath: "/audio/snake/snake_bite_danger1_english.wav",
      audioSwPath: "/audio/snake/snake_bite_danger1_swahili.wav"
    },
    { 
      en: 'Cut into the wound or make incisions', 
      sw: 'Kata jeraha au fanya mikato',
      audioEnPath: "/audio/snake/snake_bite_danger2_english.wav",
      audioSwPath: "/audio/snake/snake_bite_danger2_swahili.wav"
    },
    { 
      en: 'Apply ice, cold water, or submerge in water', 
      sw: 'Weka barafu, maji baridi, au kuzamisha majini',
      audioEnPath: "/audio/snake/snake_bite_danger3_english.wav",
      audioSwPath: "/audio/snake/snake_bite_danger3_swahili.wav"
    },
    { 
      en: 'Give alcohol, caffeine, or stimulants to the victim', 
      sw: 'Mpa mhanga pombe, kifeine, au vichochezi',
      audioEnPath: "/audio/snake/snake_bite_danger4_english.wav",
      audioSwPath: "/audio/snake/snake_bite_danger4_swahili.wav"
    },
    { 
      en: 'Try to kill or capture the snake for identification', 
      sw: 'Jaribu kuua au kukamata nyoka kwa utambulisho',
      audioEnPath: "/audio/snake/snake_bite_danger5_english.wav",
      audioSwPath: "/audio/snake/snake_bite_danger5_swahili.wav"
    },
    { 
      en: 'Elevate the bitten limb above heart level', 
      sw: 'Inua kiungo kilichoumwa juu ya kiwango cha moyo',
      audioEnPath: "/audio/snake/snake_bite_danger6_english.wav",
      audioSwPath: "/audio/snake/snake_bite_danger6_swahili.wav"
    }
  ],
  criticalSigns: [
    { 
      ...
      audioEnPath: "/audio/snake/snake_bite_sign1_english.wav",
      audioSwPath: "/audio/snake/snake_bite_sign1_swahili.wav"
    },
    { 
      en: 'Consciousness: Confusion, drowsiness, or loss of consciousness', 
      sw: 'Ufahamu: Kuchanganyikiwa, usingizi, au kupoteza fahamu',
      audioEnPath: "/audio/snake/snake_bite_sign2_english.wav",
      audioSwPath: "/audio/snake/snake_bite_sign2_swahili.wav"
    },
    { 
      ...
      audioEnPath: "/audio/snake/snake_bite_sign3_english.wav",
      audioSwPath: "/audio/snake/snake_bite_sign3_swahili.wav"
    },
    { 
      ...
      audioEnPath: "/audio/snake/snake_bite_sign4_english.wav",
      audioSwPath: "/audio/snake/snake_bite_sign4_swahili.wav"
    },
    { 
      en: 'Systemic symptoms: Nausea, vomiting, or allergic reactions', 
      sw: 'Dalili za mfumo: Kichefuchefu, kutapika, au athari za mzio',
      audioEnPath: "/audio/snake/snake_bite_sign5_english.wav",
      audioSwPath: "/audio/snake/snake_bite_sign5_swahili.wav"
    }
  ],
  additionalInfo: { 
    ...
    audioEnPath: "/audio/snake/snake_bite_additional_info_english.wav",
    audioSwPath: "/audio/snake/snake_bite_additional_info_swahili.wav"
  }
};
