...
const guide: GuideData = {
  id: 'burns',
  title: { en: 'Burns Treatment', sw: 'Burns Treatment' },
  ...
  steps: [
    ...
    },
    {
      instruction: { 
        ...
        sw: "Cool the burned area with room temperature water (20°C) for at least 20 minutes."
      },
    ...
    },
    {
      instruction: { 
        ...
        sw: "Use running water if possible, or immerse the burned area if it's an arm or leg."
      },
    ...
    },
    {
      instruction: { 
        ...
        sw: "Remove any jewelry or tight items from the burned area before swelling occurs."
      },
    ...
    },
    {
      instruction: { 
        ...
        sw: "If running water isn't available, use a clean, wet cloth at room temperature."
      },
      videoId: "/videos/training/Burn%20Injury/VIDEO%205.mp4"
    },
    {
      instruction: { 
        ...
        sw: "Only cool the burned area, not the entire body, to prevent hypothermia."
      }
    },
    {
      instruction: { 
        en: "After cooling, loosely cover the burn with a sterile bandage or clean, non-stick cloth.", 
        sw: "After cooling, loosely cover the burn with a sterile bandage or clean, non-stick cloth."
      },
